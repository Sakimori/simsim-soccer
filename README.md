# flútbol
# simsim soccer discord bot

blaseball, blaseball, is **soccer!** in an unofficial capacity. this project is also completely unaffiliated with the game band.

we will have custom players (generated by onomancer), custom teams, custom leagues, all set up in discord and watchable at <url pending! 

if you would like to add <bot name to your server to be able to set up teams and games, you can do so with this link: <bot link
...
## commands: (everything here is case sensitive, and can be prefixed with either <prefixes)
### team commands:
